...
apt-get -y install libgl-dev libglx-dev --allow-downgrades
aptitude -y install libgl-dev libglx-dev
...
apt-get -y install python3-pip libxcb-xkb-dev libfontconfig-dev libavcodec58 libavcodec-dev libavformat-dev libavutil-dev libswscale-dev libswresample-dev libavfilter-dev
