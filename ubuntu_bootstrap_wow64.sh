...
if [ -d /usr/lib/x86_64-linux-gnu ]; then wget -O wine.deb https://dl.winehq.org/wine-builds/ubuntu/dists/plucky/main/binary-amd64/wine-stable_9.0.0.0~plucky-1_amd64.deb; fi
